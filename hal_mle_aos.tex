...
\input{main/00_intro}
\input{main/01_HAL}
\input{main/02_HAL_MLE}
\input{main/03_HAL_TMLE}
\input{main/05_simulation}
\input{main/06_case_study}
...
\begin{supplement}
\stitle{Supplement to ``HAL-MLE Log-Splines Density Estimation (Part I: Univariate)''}
\sdescription{Contains all former appendix materials, including notation and technical definitions, proofs of the main theorems, additional simulation figures, DGP specifications, and optimization-algorithm details.}
\end{supplement}

...
This appendix includes the proof of Theorem 4.8 in the main paper.
\begin{proof}
We extended the Basis Boundedness Assumption in Theorem 4.6 of the main paper such that $R_{1n}(\bar{\phi}_{n,x})$ and $\tilde{r}_n(\bar{\phi}_{n,x})$ hold uniformly in $x\in [0,1]$. 

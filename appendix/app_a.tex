...
HAL-TMLE: TMLE that uses HAL for estimation of nuisance functions \\
...
CV: Cross Validation \\
cadlag function: multivariate real-valued function on (say) unit cube $[0, 1]^d$ that is right-continuous with left-hand limits \\

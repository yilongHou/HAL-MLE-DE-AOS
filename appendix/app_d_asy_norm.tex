...
This appendix includes the proof of Theorem 4.4, Theorem 4.6, and Corollary 4.7 in the main paper.
...
Notice that $p_{\tilde f_n} - p_{f_n}/p_{f_{n,0}}$ is a score in $L_0^2(P_{f_{n,0}})$, that is to say, the integration under measure $P_{f_{n,0}}$ is 0. And then use the inner product defined in Eq. (4.2) of the main paper, we can identify the term as a projection of a score in $L_0^2(P_{f_{n,0}})$ to the space $D^{(k)}(\mathcal{R}_{n,0})$. 
\begin{align*}
...
\subsection{Proof of Corollary 4.7 in the main paper}
\begin{proof}

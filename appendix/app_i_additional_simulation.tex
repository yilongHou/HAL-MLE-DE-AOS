...
\noindent This appendix provides additional simulation results complementing Section 6 of the main paper. It includes detailed visual summaries and diagnostics across all DGPs and sample sizes.
...
\subsection{Pointwise Asymptotic normality and variance estimation}\label{app_i_subsec:asymptotic_normality_and_var_est}
This subsection provides full pointwise asymptotic normality and variance estimation panels for all six DGPs.
\begin{figure}[tbp]
    \centering
...
This subsection provides full asymptotic-efficiency comparison panels for all six DGPs.
\begin{figure}[tbp]
    \centering
...
This subsection reports detailed EIC-based coverage tables and CI-width/coverage plots for all six DGPs.

\input{resources/target_estimand_variance/coverage_targeting_mean.tex}
\input{resources/target_estimand_variance/coverage_targeting_second_moment.tex}
\input{resources/target_estimand_variance/coverage_targeting_survival_0_5.tex}
\input{resources/target_estimand_variance/coverage_targeting_median.tex}
